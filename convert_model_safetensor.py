...
import json
# 
model_index_path = "/mnt/synology2/huggingface/sdxl_019b"
# model_json = json.load(model_index_path, "model_index")
# pipe = StableDiffusionXLPipeline.from_pretrained("/mnt/synology2/huggingface/sdxl_019b" , torch_dtype=torch.float16)
